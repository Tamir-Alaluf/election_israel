...
export const parties = [
  {
    ...
    futurePromisesItems: [
      ...
      },
      {
        ...
        description:
          "האצת שיווק קרקעות ותכנון מהיר יותר של שכונות חדשות.",
      },
      {
        title: "חיזוק הנגב והגליל",
        description:
          "השקעה בתעסוקה, תשתיות ושירותים ציבוריים בפריפריה.",
      },
      {
        title: "קידום חדשנות וטכנולוגיה",
        description:
          "תמרוץ תעשיות מתקדמות והרחבת השקעות במחקר ופיתוח.",
      },
      {
        title: "שיפור מערכת החינוך",
        description:
          "חיזוק לימודי ליבה והרחבת תוכניות מצוינות בפריסה ארצית.",
      },
      {
        title: "ייעול השירות הציבורי",
        description:
          "הרחבת שירותים דיגיטליים והקטנת עומסים בירוקרטיים לאזרח.",
      },
    ],
  ...
  },
  {
    ...
    futurePromisesItems: [
      ...
      },
      {
        ...
        description:
          "קידום צעדים אזרחיים לצמצום השפעה דתית במרחב הציבורי.",
      },
      {
    ...
    futurePromisesItems: [
      {
        ...
        description:
          "קידום שיח מאחד והפחתת קיטוב בין קבוצות בחברה הישראלית.",
      },
      {
        title: "שיקום האמון במוסדות",
        description:
          "חיזוק תפקוד הגופים הציבוריים ושיפור אמון הציבור במערכת.",
      },
      {
    ...
    futurePromisesItems: [
      {
        ...
        description:
          "הרחבת מענקים, סיוע כלכלי ותוכניות רווחה למשפחות במצוקה.",
      },
      {
  ...
  },
  {
    ...
    futurePromisesItems: [
      ...
      },
      {
        ...
        description:
          "חיזוק ההגנה על תנאי העסקה, שכר הוגן וביטחון תעסוקתי.",
      },
      {
    ...
    futurePromisesItems: [
      {
        ...
        description:
          "הגדלת תקצוב מוסדות תורניים ושמירה על יציבותם הכלכלית.",
      },
      {
        title: "שמירה על סטטוס-קוו דתי",
        description:
          "המשך קידום מדיניות מסורתית בתחומי דת ומדינה.",
      },
      {
        title: "הגנה על אוטונומיית החינוך החרדי",
        description:
          "שימור עצמאות מוסדות החינוך החרדיים בתכנים ובניהול.",
      },
    ],
    values: {
      type: "חרדית",
